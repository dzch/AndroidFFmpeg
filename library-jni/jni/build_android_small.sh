...
function build_ffmpeg
{
	...
	./configure --target-os=linux \
		...
		--disable-protocols --disable-hwaccels --disable-decoders --disable-parsers --disable-demuxers --disable-muxers \
		--enable-decoder=h264 --enable-decoder=aac --enable-decoder=aac_fixed --enable-decoder=aac_latm \
